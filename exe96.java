class Exp96{ int rollno; String name; String city;

Exp96(int rollno, String name, String city){ this.rollno=rollno;
...
public static void main(String args[]){ Exp96 s1=new Exp96(101,"Raj","lucknow");
